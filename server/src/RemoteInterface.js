...
class RemoteInterface {
  ...
  handleNewClient(client) {
    ...
    for (let currentClient of this.clients) {
      let newMessage = '';
      if (currentClient != client) {
        newMessage = `New client have been connected. `;
      }
      newMessage += `There are a total of ${this.clients.length} players currently in the game`;
      currentClient.write(newMessage);
    }
